...
Game.statistics = (function(){
    ...
    instance.initialise = function() {
        ...
        this.createStatistic("placesExplored", Game.constants.statisticCategoryUnlockable, "探险地点", 10);
        this.createStatistic("wondersBuilt", Game.constants.statisticCategoryUnlockable, "奇迹建造", 4);
        this.createStatistic("wondersActivated", Game.constants.statisticCategoryUnlockable, "奇迹激活", 9);
        this.createStatistic("rebirthCount", Game.constants.statisticCategoryUnlockable, "再生时间", 0);  
